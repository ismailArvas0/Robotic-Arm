...
ROBOT KOL: Robot kol için 4 tane servo motoruna ben MG90S model servo motorları kullandım ve servo motorların düzgün çalışması için bir Servo motor sürücüsüne ihtiyacınız olacak.
